...
var wiki = (function(w,d) {

  /* basic_patterns is a sequential associative array containing
   * an ordering index as a key and a list of strings.
   ...
   *    test:           a sample  input to test functionality
